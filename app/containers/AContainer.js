...
export default class AContainer extends Component {
  ...
  render() {
    return (
      <View style={styles.container}>
        <Text style={styles.welcome}>THIS IS AAAAAAAAAAA!</Text>
  ...
  handleAppStateChange = (appState) => {
    ...
    this.notif.scheduleNotif("Title of AAAAA", "This is schedule notif after " + this.state.seconds + " seconds", this.state.seconds)
    }
  }
}
